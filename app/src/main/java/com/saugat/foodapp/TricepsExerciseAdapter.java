...
public class TricepsExerciseAdapter extends ArrayAdapter<TricepsExercise> {

    private int layoutResource;

    public TricepsExerciseAdapter(Context context, int resource, List<TricepsExercise> exercises) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TricepsExercise exercise = getItem(position);
    ...
    @Override
    public TricepsExercise getItem(int position) {
        // We explicitly cast the return value to ChestExercise
        return (TricepsExercise) super.getItem(position);
    }
}
